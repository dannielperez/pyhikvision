...
- state: implemented and locally/live validated; draft PR pending
...
- validations: `PYTHONPATH=src pytest -q` OK 95 passed; changed-file Ruff check and format check OK; exact branch code live-probed through UAT against Estancias with both channel 6 (`602`, 4.358s) and channel 16 (`1601`, 6.513s) returning JPEGs
